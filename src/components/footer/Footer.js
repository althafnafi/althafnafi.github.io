...
const Footer = () => {
    ...
    return (
        <footer className="mt-16 mb-10 font-mono text-white text-xs">
            <div className="flex justify-center my-4">
                <p> - Reach me down below - </p>
            </div>
            <div>
                <ul className="flex flex-row justify-center space-x-7">
                    <li><a href="https://www.instagram.com/althafnafi_/">
                    ...
                    <li><a href="https://www.linkedin.com/in/althaf-n-294baa12a/">
                    ...
                    <li><a href="https://github.com/althafnafi">
